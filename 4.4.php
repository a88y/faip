<?php
	...
	$pagesEdit = '';
	$actionSave = 'add';
	$titleHeader = 'IV.4 Karya Temuan / Inovasi / Paten dan Implementasi Teknologi Baru';
	$titleHeaderAction = '';
	$tempat = '';
	$uraian = '';
	$referemsi = '';
	...
	if ( isset($_GET['action']) && $_GET['action']=='edit' ) {  
		if(isset($_GET['id'])){
			...
			$query_id = "select * from 4_4_detail where id_4_4_detail = '".$id."' limit 1";
			...
			if( mysqli_num_rows($result_id) > 0 ) {
				while($row_id = mysqli_fetch_array($result_id)) {
					...
					$id_4_4				= $row_id["id_4_4"];
					$id_4_4_detail		= $row_id["id_4_4_detail"];
					$tempat				= $row_id["tempat"];
					$uraian				= $row_id["uraian"];
					$referemsi			= $row_id["referemsi"];
					$status				= $row_id["status"];
					
					$query_tt = "select * from 4_4_pqr where id_4_4_detail = '".$id_4_4_detail."' limit 1";
					...
					$query_xx = "select * from 4_4 where id_4_4 = '".$id_4_4."' && id_user = '".$_SESSION['id_u5er']."' limit 1";
					...
					if( mysqli_num_rows($result_xx) > 0 ) {
						...
						header('location: ./4.4.php?err=='.base64_encode('Id tidak ditemukan.'));		
						exit();
					}
...
<?php
	$query_1 = "select t1.id_user, t1.id_4_4, IFNULL(t1.total_penilaian_penilai ,t1.total_penilaian) as total_penilaian, t2.id_4_4_detail, t2.tempat, t2.uraian, t2.referemsi, t2.status, t3.jenis, IFNULL(t3.nilai_p_penilai ,t3.nilai_p) as nilai_p, t3.peran, IFNULL(t3.nilai_q_penilai ,t3.nilai_q) as nilai_q, t3.cakupan, IFNULL(t3.nilai_r_penilai ,t3.nilai_r) as nilai_r
				from 4_4 as t1
				join 4_4_detail as t2 on t2.id_4_4 = t1.id_4_4
				join 4_4_pqr as t3 on t3.id_4_4_detail = t2.id_4_4_detail
				where t1.id_user = '".$_SESSION['id_u5er']."' order by t2.id_4_4_detail asc";
							...
							<div class="box-content nopadding">
								<form action="#" method="post" class="form-horizontal form-bordered">
									...
									<div class="control-group">
										<label class="control-label">Judul Temuan/Inovasi/Paten dan Implementasi Teknologi Baru dan semua nama yang ikut memiliki HAKI</label>
										<div class="controls">
                                            <div class="input-block-level"><p><?php echo $row_1["tempat"]?></p></div>
										</div>
									</div>
                                     
									<div class="control-group">
										<label class="control-label">Uraian singkat keunikan, terobosan dan dampak manfaat Karya yang dihasilkan</label>
										<div class="controls">
                                            <div class="input-block-level"><p><?php echo $row_1["uraian"]?></p></div>
										</div>
									</div>
                                       
									<div class="control-group">
										<label class="control-label">Referensi Dokumen Paten, Permohonan Paten, Laporan/Pemaparan atau Publikasi Karya yang dihasilkan</label>
										<div class="controls">
                                            <div class="input-block-level"><p><?php echo $row_1["referemsi"]?></p></div>
										</div>
									</div>
                                       
									<div class="control-group">
										<label class="control-label">Status penerapan dan/atau komersialisasi Hasil Karya</label>
										<div class="controls">
                                            <div class="input-block-level"><p><?php echo $row_1["status"]?></p></div>
										</div>
									</div>
                                                                                    
                                    <div class="control-group">
										<label class="control-label">Jenis Karya Temuan / Inovasi / Paten</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label">Cakupan Karya Temuan / Inovasi / Paten</label>
										<div class="controls">
                                    ...
                                    <div class="control-group">
										<label class="control-label">Kompetensi yang relevan dengan Karya Temuan/Inovasi/Paten dan Implementasi Teknologi Baru</label>
										<div class="controls">
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, id_4_4_detail, kompetensi, nilai_kompetensi from 4_4_kompetensi where id_4_4_detail = '".$row_1["id_4_4_detail"]."' order by id_kompetensi asc";	
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<?php if($pagesEdit != true && $status_penilai == 0){ ?>
                                            		<a href="./4.4.php?action=edit&id=<?php echo base64_encode($row_1["id_4_4_detail"]) ?>"><div class="btn btn-primary btn-edit">Edit</div></a>							
											<?php } else { ?>
				...
				<div id="coloumn-content" class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							...
							<div class="box-content nopadding">
                                <form action="./func/4.4.add.php" method="post" class="form-horizontal form-bordered form-validate" id="form1">
									...
									<div class="control-group">
										<label class="control-label">Judul Temuan/Inovasi/Paten dan Implementasi Teknologi Baru dan semua nama yang ikut memiliki HAKI</label>
										<div class="controls">                                        
                                        	<textarea name="txtJudul" id="txtJudul" rows="3" class="input-block-level" data-rule-required="true"><?php echo $tempat ?></textarea>
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Uraian singkat keunikan, terobosan dan dampak manfaat Karya yang dihasilkan</label>
										<div class="controls">                                        
                                        	<textarea name="txtUraian" id="txtUraian" rows="3" class="input-block-level" data-rule-required="true"><?php echo $uraian ?></textarea>
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Referensi Dokumen Paten, Permohonan Paten, Laporan/Pemaparan atau Publikasi Karya yang dihasilkan</label>
										<div class="controls">                                        
                                        	<textarea name="txtReferensi" id="txtReferensi" rows="3" class="input-block-level" data-rule-required="true"><?php echo $referemsi ?></textarea>
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Status penerapan dan/atau komersialisasi Hasil Karya</label>
										<div class="controls">                                        
                                        	<textarea name="txtStatus" id="txtStatus" rows="3" class="input-block-level" data-rule-required="true"><?php echo $status ?></textarea>
										</div>
									</div>
...
<?php
								$query_p = "select * from 4_4_p where 1;";
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiQ" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_q = "select * from 4_4_q where 1;";
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiR" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_r = "select * from 4_4_r where 1;";
...
$uu = 0;
$idKopetensi = '';
$query_k = "select * from bakuan_kompetensi where step = 'IV.4' order by id_bakuan_kompetensi asc";
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	if($pagesEdit == true){
		...
		$query_uu = "select * from 4_4_kompetensi where id_4_4_detail = '".$id_4_4_detail."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                            ...
                                            <input type="hidden" name="txtIdEdit" value="<?php echo base64_encode($id_4_4_detail) ?>"/>
                                            <a href="./4.4.php"><div class="btn btn-inverse">Batal</div></a>
                            ...
                            <div class="control-nav">
                                <a href="./4.3.php"><div class="btn btn-primary">Prev</div></a>
                                <a href="./5.1.php"><div class="btn btn-primary">Next</div></a>
                            </div>
						</div>
					</div>
				</div>
