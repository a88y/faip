<?php
	...
	$pagesEdit = '';
	$actionSave = 'add';
	$titleHeader = 'III.4 Pengalaman dalam Pekerjaan Manufaktur atau Produksi dan/atau Konsultasi Perekayasaan dan/atau Konstruksi / Instalasi';
	$titleHeaderAction = '';
	$kegiatan = '';
	$nama = '';
	$perguruan = '';
	...
	if ( isset($_GET['action']) && $_GET['action']=='edit' ) {  
		if(isset($_GET['id'])){
			...
			$query_id = "select * from 3_4_detail where id_3_4_detail = '".$id."' limit 1";
			...
			if( mysqli_num_rows($result_id) > 0 ) {
				while($row_id = mysqli_fetch_array($result_id)) {
					...
					$id_3_4				= $row_id["id_3_4"];
					$id_3_4_detail		= $row_id["id_3_4_detail"];
					...
					$query_tt = "select * from 3_4_pqr where id_3_4_detail = '".$id_3_4_detail."' limit 1";
					...
					$query_uu = "select * from 3_4_p_parent where id_3_4_p_parent = '".$selectNilaiParent."' limit 1";
					...
					$query_xx = "select * from 3_4 where id_3_4 = '".$id_3_4."' && id_user = '".$_SESSION['id_u5er']."' limit 1";
					...
					if( mysqli_num_rows($result_xx) > 0 ) {
						...
						header('location: ./3.4.php?err=='.base64_encode('Id tidak ditemukan.'));		
						exit();
					}
...
<?php
	$query_1 = "select t1.id_user, t1.id_3_4, IFNULL(t1.total_penilaian_penilai ,t1.total_penilaian) as total_penilaian, t2.id_3_4_detail, t2.kegiatan, t2.nama, t2.perguruan, t2.sejak, t2.sampai, t2.client, t2.pemilik, t3.id_jenis_parent, t3.jenis, IFNULL(t3.nilai_p_penilai ,t3.nilai_p) as nilai_p, t3.peran, IFNULL(t3.nilai_q_penilai ,t3.nilai_q) as nilai_q, t3.cakupan, IFNULL(t3.nilai_r_penilai ,t3.nilai_r) as nilai_r, t4.parent
				from 3_4 as t1
				join 3_4_detail as t2 on t2.id_3_4 = t1.id_3_4
				join 3_4_pqr as t3 on t3.id_3_4_detail = t2.id_3_4_detail
				join 3_4_p_parent as t4 on t4.id_3_4_p_parent = t3.id_jenis_parent	
				where t1.id_user = '".$_SESSION['id_u5er']."' order by t2.id_3_4_detail asc";
						...
						?>
							<div class="box-content nopadding">
								<form action="#" method="post" class="form-horizontal form-bordered">
                                    ...
                                    <div class="control-group">
										<label class="control-label">Kompetensi yang relevan dengan Pengalaman Manufaktur/Produksi, Konsultasi Perekayasaan, Konsruksi/Instalasi</label>
										<div class="controls">
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, id_3_4_detail, kompetensi, nilai_kompetensi from 3_4_kompetensi where id_3_4_detail = '".$row_1["id_3_4_detail"]."' order by id_kompetensi asc";	
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<?php if($pagesEdit != true && $status_penilai == 0){ ?>
                                            		<a href="./3.4.php?action=edit&id=<?php echo base64_encode($row_1["id_3_4_detail"]) ?>"><div class="btn btn-primary btn-edit">Edit</div></a>								
											<?php } else { ?>
				...
				<div id="coloumn-content" class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							...
							<div class="box-content nopadding">
                                <form action="./func/3.4.add.php" method="post" class="form-horizontal form-bordered form-validate" id="form1">
...
<?php
								$query_p_parent = "select * from 3_4_p_parent where 1;";
								$result_p_parent = mysqli_query($dbLink,$query_p_parent);
								while($row_p_parent = mysqli_fetch_array($result_p_parent)) {
?>
                                                <li class="<?php if($row_p_parent['id_3_4_p_parent'] == $selectNilaiParent) { echo "selected"; } ?>"><div data-value="<?php echo $row_p_parent['parent']?>" data-nilai="<?php echo $row_p_parent['id_3_4_p_parent']?>"><?php echo $row_p_parent['parent']?></div></li>
<?php
								}
?>
                                            	</ul>
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiP" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_p_parent_s = "select * from 3_4_p_parent where 1;";
								$result_p_parent_s = mysqli_query($dbLink,$query_p_parent_s);
								while($row_p_parent_s = mysqli_fetch_array($result_p_parent_s)) {
									
									$query_p = "select * from 3_4_p where id_3_4_p_parent = '".$row_p_parent_s["id_3_4_p_parent"]."' order by nilai_p desc";
									$result_p = mysqli_query($dbLink,$query_p);
									while($row_p = mysqli_fetch_array($result_p)) {
										
?>
													<li class="<?php if($row_p['jenis'] == $selectNilaiP) { echo "selected"; } ?>" data-filter="<?php echo $row_p_parent_s["id_3_4_p_parent"]?>" style=" <?php if($row_p["id_3_4_p_parent"] == $selectNilaiParent ){ echo 'display:block;'; } else { echo 'display:none;'; } ?> "><div data-value="<?php echo $row_p['jenis']?>" data-nilai="<?php echo $row_p['nilai_p']?>"><?php echo $row_p['jenis']?></div></li>                                           	
<?php
									}
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiQ" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_q = "select * from 3_4_q where 1;";
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiR" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_r = "select * from 3_4_r where 1;";
...
$uu = 0;
$idKopetensi = '';
$query_k = "select * from bakuan_kompetensi where step = 'III.4' order by id_bakuan_kompetensi asc";
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	if($pagesEdit == true){
		...
		$query_uu = "select * from 3_4_kompetensi where id_3_4_detail = '".$id_3_4_detail."' && kompetensi = '".$valueKopetensi."' limit 1";
		$result_uu = mysqli_query($dbLink,$query_uu);
		if( mysqli_num_rows($result_uu) > 0 ) {
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                            ...
                                            <input type="hidden" name="txtIdEdit" value="<?php echo base64_encode($id_3_4_detail) ?>"/>
                                            <a href="./3.4.php"><div class="btn btn-inverse">Batal</div></a>
                            ...
                            <div class="control-nav">
                                <a href="./3.3.php"><div class="btn btn-primary">Prev</div></a>
                                <a href="./3.5.php"><div class="btn btn-primary">Next</div></a>
                            </div>
						</div>
					</div>
				</div>
