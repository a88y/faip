<?php
	...
	$pagesEdit = '';
	$actionSave = 'add';
	$titleHeader = 'I.6 Pendidikan / Pelatihan Manajemen dan Pendidikan Lainnya (yang Relevan) yang Diikuti';
	$titleHeaderAction = '';
	$nama_program = '';
	$tgl = '';
	$tempat = '';
	...
	if ( isset($_GET['action']) && $_GET['action']=='edit' ) {  
		if(isset($_GET['id'])){
			...
			$query_id = "select * from 1_6_detail where id_1_6_detail = '".$id."' limit 1";
			...
			if( mysqli_num_rows($result_id) > 0 ) {
				while($row_id = mysqli_fetch_array($result_id)) {
					...
					$id_1_6			= $row_id["id_1_6"];
					$id_1_6_detail	= $row_id["id_1_6_detail"];
					$nama_program	= $row_id["nama_program"];
					$tgl			= $row_id["tgl"];
					$tempat			= $row_id["tempat"];
					$penyelenggara	= $row_id["penyelenggara"];
					
					$query_tt = "select * from 1_6_pqr where id_1_6_detail = '".$id_1_6_detail."' limit 1";
					$result_tt = mysqli_query($dbLink,$query_tt);
					if( mysqli_num_rows($result_tt) > 0 ) {
						while($row_tt = mysqli_fetch_array($result_tt)) {
							$selectNilaiP 	  = $row_tt["peran"];
							$nilaiP 		  = $row_tt["nilai_p"];
							$selectNilaiQ 	  = $row_tt["jenis"];
					...
					$query_xx = "select * from 1_6 where id_1_6 = '".$id_1_6."' && id_user = '".$_SESSION['id_u5er']."' limit 1";
					...
					if( mysqli_num_rows($result_xx) > 0 ) {
						...
						header('location: ./1.6.php?err=='.base64_encode('Id tidak ditemukan.'));		
						exit();
					}
...
<?php
	$query_1 = "select t1.id_user, t1.id_1_6, IFNULL(t1.total_penilaian_penilai ,t1.total_penilaian) as total_penilaian, t2.id_1_6_detail, t2.nama_program, t2.tgl, t2.tempat, t2.penyelenggara, t3.peran, IFNULL(t3.nilai_p_penilai ,t3.nilai_p) as nilai_p, t3.jenis, IFNULL(t3.nilai_q_penilai ,t3.nilai_q) as nilai_q, t3.cakupan, IFNULL(t3.nilai_r_penilai ,t3.nilai_r) as nilai_r
				from 1_6 as t1
				join 1_6_detail as t2 on t2.id_1_6 = t1.id_1_6
				join 1_6_pqr as t3 on t3.id_1_6_detail = t2.id_1_6_detail
				where t1.id_user = '".$_SESSION['id_u5er']."' order by t2.id_1_6_detail asc";
							...
							<div class="box-content nopadding">
								<form action="#" method="post" class="form-horizontal form-bordered">
									...
									<div class="control-group">
										<label class="control-label">Nama Program Pendidikan / Pelatihan</label>
										<div class="controls">
                                            <div class="input-block-level"><p><?php echo $row_1["nama_program"]?></p></div>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
                                            <div class="input-xlarge"><p><?php echo $row_1["tgl"]?></p></div>
										</div>
									</div>
                                    
									<div class="control-group">
										<label class="control-label">Tempat Pendidikan / Pelatihan ( Kota, Negara )</label>
										<div class="controls">
                                            <div class="input-xxlarge"><p><?php echo $row_1["tempat"]?></p></div>
										</div>
									</div>
                                    
                                    <div class="control-group">
										<label class="control-label">Penyelenggara Pendidikan / Pelatihan</label>
										<div class="controls">
                                            <div class="input-xxlarge"><p><?php echo $row_1["penyelenggara"]?></p></div>
										</div>
									</div>
                                                                        
                                    <div class="control-group">
										<label class="control-label">Keterlibatan Peserta</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label">Jenis Pendidikan / Pelatihan</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label">Cakupan Pendidikan / Pelatihan</label>
										<div class="controls">
                                    ...
                                    <div class="control-group">
										<label class="control-label">Kompetensi yang Relevan dengan Pendidikan / Pelatihan Manajemen dan Lainnya</label>
										<div class="controls">
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, id_1_6_detail, kompetensi, nilai_kompetensi from 1_6_kompetensi where id_1_6_detail = '".$row_1["id_1_6_detail"]."' order by id_kompetensi asc";	
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<?php if($pagesEdit != true && $status_penilai == 0){ ?>
                                            		<a href="./1.6.php?action=edit&id=<?php echo base64_encode($row_1["id_1_6_detail"]) ?>"><div class="btn btn-primary btn-edit">Edit</div></a>									
											<?php } else { ?>
				...
				<div id="coloumn-content" class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							...
							<div class="box-content nopadding">
                                <form action="./func/1.6.add.php" method="post" class="form-horizontal form-bordered form-validate" id="form1">
									...
									<div class="control-group">
										<label class="control-label">Nama Program Pendidikan / Pelatihan</label>
										<div class="controls">
                                        <input type="text" name="txtNamaProgram" id="txtNamaProgram" class="input-block-level" value="<?php echo $nama_program ?>" data-rule-required="true">
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Tahun</label>
										<div class="controls">
                                        	<select name="txtTahun" id="txtTahun" class="input-xlarge" data-rule-required="true">
                                            	<option value="" selected disabled>Select One</option>
										<?php for( $year = strtotime('-60 years'); $year < strtotime('+5 years'); $year = strtotime('+1 years', $year) ){ ?>
                                            	<option value="<?php echo date('Y', $year)?>" <?php if(date('Y', $year) == $tgl ) echo "selected" ?>><?php echo date('Y', $year)?></option>
										<?php } ?>
                                            </select>
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Tempat Pendidikan / Pelatihan ( Kota, Negara )</label>
										<div class="controls">
                                        	<input type="text" name="txtTmpPendidikan" id="txtTmpPendidikan" class="input-xxlarge" value="<?php echo $tempat ?>">
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Penyelenggara Pendidikan / Pelatihan</label>
										<div class="controls">
                                        	<input type="text" name="txtPenyelenggara" id="txtPenyelenggara" class="input-xxlarge" value="<?php echo $penyelenggara ?>">
										</div>
									</div>
...
<?php
								$query_p = "select * from 1_6_p where 1;";
								$result_p = mysqli_query($dbLink,$query_p);
								while($row_p = mysqli_fetch_array($result_p)) {
?>
                                                <li class="<?php if($row_p['peran'] == $selectNilaiP) { echo "selected"; } ?>"><div data-value="<?php echo $row_p['peran']?>" data-nilai="<?php echo $row_p['nilai_p']?>"><?php echo $row_p['peran']?></div></li>
<?php
								}
?>
                                            	</ul>
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiQ" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_q = "select * from 1_6_q where 1;";
								$result_q = mysqli_query($dbLink,$query_q);
								while($row_q = mysqli_fetch_array($result_q)) {
?>
												<li class="<?php if($row_q['jenis'] == $selectNilaiQ) { echo "selected"; } ?>"><div data-value="<?php echo $row_q['jenis']?>" data-nilai="<?php echo $row_q['nilai_q']?>"><?php echo $row_q['jenis']?></div></li>
<?php
								}
?>
                                            	</ul>
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiR" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_r = "select * from 1_6_r where 1;";
...
$uu = 0;
$idKopetensi = '';
$query_k = "select * from bakuan_kompetensi where step = 'I.6' order by id_bakuan_kompetensi asc";
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	if($pagesEdit == true){
		...
		$query_uu = "select * from 1_6_kompetensi where id_1_6_detail = '".$id_1_6_detail."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                            ...
                                            <input type="hidden" name="txtIdEdit" value="<?php echo base64_encode($id_1_6_detail) ?>"/>
                                            <a href="./1.6.php"><div class="btn btn-inverse">Batal</div></a>
                            ...
                            <div class="control-nav">
                                <a href="./1.5.php"><div class="btn btn-primary">Prev</div></a>
                                <a href="./2.1.php"><div class="btn btn-primary">Next</div></a>
                            </div>
						</div>
					</div>
				</div>
