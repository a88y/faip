					...
					<div class="span12">
						<div class="box box-bordered box-color">
							<div class="box-title">
                                ...
                                <a href="./newuser.php">
                                    <div class="btn btn-primary" style="float:right; margin-right: 10px;">
...
<?php
	...
	$query = "select t1.id_user, t1.nama, t1.no_kta, t2.username, t2.id_credential
					from user as t1
				join login as t2 on t2.id_user = t1.id_user
					where t2.id_credential = 1
...
?>
										<tr>
											...
											<td>******</td>
											<td>
                                                <a href="./edituser.php?reff=<?=base64_encode($row['id_user'])?>" title="Edit."><img src="../img/settings.png" width="30" /></a>
                                                <a href="./func/pwdreset.php?reff=<?=base64_encode($row['id_user'])?>&user=<?=base64_encode($row['nama'])?>" title="Password Reset."><img src="../img/lock.png" width="30" /></a>
                                            </td>
										</tr>
<?php
	}
