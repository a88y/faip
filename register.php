							...
							<div class="box-content nopadding">
								<form action="./func/new_user.php" method="post" class="form-horizontal form-bordered form-validate" id="formRegister">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="txtNoKta" id="txtNoKta" class="input-xxlarge" onChange="checkAvailable('NoKta')" data-rule-required="true" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="txtEmail" id="txtEmail" class="input-xlarge" onChange="checkAvailable('Email')" data-rule-required="true" data-rule-email="true">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="./"><div class="btn">Kembali</div></a>
									</div>
