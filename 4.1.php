<?php
	...
	$pagesEdit = '';
	$actionSave = 'add';
	$titleHeader = 'IV.1 Karya Tulis di Bidang Keinsinyuran yang Dipublikasikan';
	$titleHeaderAction = '';
	$judul = '';
	$media = '';
	$uraian = '';
	...
	if ( isset($_GET['action']) && $_GET['action']=='edit' ) {  
		if(isset($_GET['id'])){
			...
			$query_id = "select * from 4_1_detail where id_4_1_detail = '".$id."' limit 1";
			...
			if( mysqli_num_rows($result_id) > 0 ) {
				while($row_id = mysqli_fetch_array($result_id)) {
					...
					$id_4_1				= $row_id["id_4_1"];
					$id_4_1_detail		= $row_id["id_4_1_detail"];
					$judul				= $row_id["judul"];
					$media				= $row_id["media"];
					$uraian				= $row_id["uraian"];
					$halaman			= $row_id["halaman"];
					
					$query_tt = "select * from 4_1_pqr where id_4_1_detail = '".$id_4_1_detail."' limit 1";
					...
					$query_xx = "select * from 4_1 where id_4_1 = '".$id_4_1."' && id_user = '".$_SESSION['id_u5er']."' limit 1";
					...
					if( mysqli_num_rows($result_xx) > 0 ) {
						...
						header('location: ./4.1.php?err=='.base64_encode('Id tidak ditemukan.'));		
						exit();
					}
...
<?php
	$query_1 = "select t1.id_user, t1.id_4_1, IFNULL(t1.total_penilaian_penilai ,t1.total_penilaian) as total_penilaian, t2.id_4_1_detail, t2.judul, t2.media, t2.uraian, t2.halaman, t3.jenis, IFNULL(t3.nilai_p_penilai ,t3.nilai_p) as nilai_p, t3.peran, IFNULL(t3.nilai_q_penilai ,t3.nilai_q) as nilai_q, t3.cakupan, IFNULL(t3.nilai_r_penilai ,t3.nilai_r) as nilai_r
				from 4_1 as t1
				join 4_1_detail as t2 on t2.id_4_1 = t1.id_4_1
				join 4_1_pqr as t3 on t3.id_4_1_detail = t2.id_4_1_detail
				where t1.id_user = '".$_SESSION['id_u5er']."' order by t2.id_4_1_detail asc";
						...
						?>
							<div class="box-content nopadding">
								<form action="#" method="post" class="form-horizontal form-bordered">
									...
									<div class="control-group">
										<label class="control-label">Nama Media, Volume, Edisi dan Tanggal Publikasi</label>
										<div class="controls">
                                            <div class="input-block-level"><p><?php echo $row_1["media"]?></p></div>
										</div>
									</div>
                                    ...
                                    <div class="control-group">
										<label class="control-label">Kompetensi yang relevan dengan Karya Tulis Keinsinyuran yang Dipublikasikan</label>
										<div class="controls">
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, id_4_1_detail, kompetensi, nilai_kompetensi from 4_1_kompetensi where id_4_1_detail = '".$row_1["id_4_1_detail"]."' order by id_kompetensi asc";	
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<?php if($pagesEdit != true && $status_penilai == 0){ ?>
                                            		<a href="./4.1.php?action=edit&id=<?php echo base64_encode($row_1["id_4_1_detail"]) ?>"><div class="btn btn-primary btn-edit">Edit</div></a>								
											<?php } else { ?>
				...
				<div id="coloumn-content" class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							...
							<div class="box-content nopadding">
                                <form action="./func/4.1.add.php" method="post" class="form-horizontal form-bordered form-validate" id="form1">
									...
									<div class="control-group">
										<label class="control-label">Nama Media, Volume, Edisi dan Tanggal Publikasi</label>
										<div class="controls">                                        
                                        	<textarea name="txtMedia" id="txtMedia" rows="3" class="input-block-level" data-rule-required="true"><?php echo $media ?></textarea>
										</div>
									</div>
...
<?php
								$query_p = "select * from 4_1_p where 1;";
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiQ" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_q = "select * from 4_1_q where 1;";
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiR" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_r = "select * from 4_1_r where 1;";
...
$uu = 0;
$idKopetensi = '';
$query_k = "select * from bakuan_kompetensi where step = 'IV.1' order by id_bakuan_kompetensi asc";
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	if($pagesEdit == true){
		...
		$query_uu = "select * from 4_1_kompetensi where id_4_1_detail = '".$id_4_1_detail."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                            ...
                                            <input type="hidden" name="txtIdEdit" value="<?php echo base64_encode($id_4_1_detail) ?>"/>
                                            <a href="./4.1.php"><div class="btn btn-inverse">Batal</div></a>
                            ...
                            <div class="control-nav">
                                <a href="./3.5.php"><div class="btn btn-primary">Prev</div></a>
                                <a href="./4.2.php"><div class="btn btn-primary">Next</div></a>
                            </div>
						</div>
					</div>
				</div>
