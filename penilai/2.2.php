...
<?php
	$query_1 = "select t1.id_user, t1.id_2_2, IFNULL(t1.total_penilaian_penilai, t1.total_penilaian) total_penilaian, t2.id_2_2_detail, t2.pendapat, t2.tgl, t2.program, t3.akibat, t3.nilai_p, t3.peran, t3.nilai_q, t3.cakupan, t3.nilai_r, t3.akibat_penilai, t3.nilai_p_penilai, t3.peran_penilai, t3.nilai_q_penilai, t3.cakupan_penilai, t3.nilai_r_penilai
				from 2_2 as t1
				join 2_2_detail as t2 on t2.id_2_2 = t1.id_2_2
				join 2_2_pqr as t3 on t3.id_2_2_detail = t2.id_2_2_detail
				where t1.id_user = '".$id_user."' order by t2.id_2_2_detail asc";
							...
							<div class="box-content nopadding">
								<form action="#" method="post" class="form-horizontal form-bordered">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<div class="fullwidth">
                                        		<input type="text" name="txtSelectNilaiP" class="input-block-level input-nilai txtSelectCustom" value="<?php echo $row_1["akibat_penilai"] ?>" placeholder="Select One" readonly />
...
?>
                                                <li class="<?php if($row_p['akibat'] == $row_1["akibat_penilai"]) { echo "selected"; } ?>"><div data-value="<?php echo $row_p['akibat']?>" data-nilai="<?php echo $row_p['nilai_p']?>"><?php echo $row_p['akibat']?></div></li>
<?php
								}
?>
                                            	</ul>
...
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, kompetensi, nilai_kompetensi from 2_2_kompetensi where id_2_2_detail = '".$row_1["id_2_2_detail"]."' order by id_kompetensi asc";	
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	$query_uu = "select * from 2_2_kompetensi where id_2_2_detail = '".$row_1["id_2_2_detail"]."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<input type="hidden" name="id_detail" value="<?=$row_1["id_2_2_detail"]?>" />
