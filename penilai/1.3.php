...
<?php
	$query_1 = "select t1.id_user, t1.id_organisasi, IFNULL(t1.total_penilaian_penilai, t1.total_penilaian) total_penilaian, t2.id_organisasi_detail, t2.nama_organisasi, t2.sejak, t2.sampai, t2.kedudukan, t3.id_jenis_parent, t3.jenis, t3.nilai_p, t3.cakupan, t3.nilai_q, t3.peran, t3.nilai_r, t3.id_jenis_parent_penilai, t3.jenis_penilai, t3.nilai_p_penilai, t3.cakupan_penilai, t3.nilai_q_penilai, t3.peran_penilai, t3.nilai_r_penilai, t4.parent
				from 1_3 as t1
				...
				where t1.id_user = '".$id_user."' order by t2.id_organisasi_detail asc";
                ...
                <div id="divContent" class="row-fluid">
					<div class="span12">
						...
						<?php  while ( $row_1 = mysqli_fetch_array($result_1) ) { 
									...
									$query_uu = "select * from 1_3_p_parent where id_1_3_p_parent = '".$row_1["id_jenis_parent_penilai"]."' limit 1";
...
?>
                                                <li class="<?php if($row_p_parent['id_1_3_p_parent'] == $row_1["id_jenis_parent_penilai"]) { echo "selected"; } ?>"><div data-value="<?php echo $row_p_parent['parent']?>" data-nilai="<?php echo $row_p_parent['id_1_3_p_parent']?>"><?php echo $row_p_parent['parent']?></div></li>
<?php
								}
?>
                                            	</ul>
...
?>
													<li class="<?php if($row_p['jenis'] == $row_1["jenis_penilai"]) { echo "selected"; } ?>" data-filter="<?php echo $row_p_parent_s["id_1_3_p_parent"]?>" style=" <?php if($row_p["id_1_3_p_parent"] == $row_1["id_jenis_parent_penilai"] ){ echo 'display:block;'; } else { echo 'display:none;'; } ?> "><div data-value="<?php echo $row_p['jenis']?>" data-nilai="<?php echo $row_p['nilai_p']?>"><?php echo $row_p['jenis']?></div></li>                                           	
<?php
									}
...
?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<div class="fullwidth">
                                        		<input type="text" name="txtSelectNilaiQ" class="input-block-level input-nilai txtSelectCustom" value="<?php echo $row_1["cakupan_penilai"] ?>" placeholder="Select One" readonly />
...
?>
												<li class="<?php if($row_q['cakupan'] == $row_1["cakupan_penilai"]) { echo "selected"; } ?>"><div data-value="<?php echo $row_q['cakupan']?>" data-nilai="<?php echo $row_q['nilai_q']?>"><?php echo $row_q['cakupan']?></div></li>
<?php
								}
?>
                                            	</ul>
									...
									<div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<div class="fullwidth">
                                        		<input type="text" name="txtSelectNilaiR" class="input-block-level input-nilai txtSelectCustom" value="<?php echo $row_1["peran_penilai"] ?>" placeholder="Select One" readonly />
                                                <ul class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="">Select One</div></li>
<?php
...
?>
                                                <li class="<?php if($row_r['peran'] == $row_1["peran_penilai"]) { echo "selected"; } ?>"><div data-value="<?php echo $row_r['peran']?>" data-nilai="<?php echo $row_r['nilai_r']?>"><?php echo $row_r['peran']?></div></li>
<?php
								}
?>
                                            	</ul>
...
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, nilai_kompetensi, kompetensi from 1_3_kompetensi where id_organisasi_detail = '".$row_1["id_organisasi_detail"]."' order by id_kompetensi asc";	
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	$query_uu = "select * from 1_3_kompetensi where id_organisasi_detail = '".$row_1["id_organisasi_detail"]."' && kompetensi = '".$valueKopetensi."' limit 1";
	$result_uu = mysqli_query($dbLink,$query_uu);
	if( mysqli_num_rows($result_uu) > 0 ) {
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<input type="hidden" name="id_detail" value="<?=$row_1["id_organisasi_detail"]?>" />
