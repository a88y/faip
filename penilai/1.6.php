...
<?php
	$query_1 = "select t1.id_user, t1.id_1_6, IFNULL(t1.total_penilaian_penilai, t1.total_penilaian) total_penilaian, t2.id_1_6_detail, t2.nama_program, t2.tgl, t2.tempat, t2.penyelenggara, t3.peran, t3.nilai_p, t3.jenis, t3.nilai_q, t3.cakupan, t3.nilai_r, t3.peran_penilai, t3.nilai_p_penilai, t3.jenis_penilai, t3.nilai_q_penilai, t3.cakupan_penilai, t3.nilai_r_penilai
				from 1_6 as t1
				join 1_6_detail as t2 on t2.id_1_6 = t1.id_1_6
				join 1_6_pqr as t3 on t3.id_1_6_detail = t2.id_1_6_detail
				where t1.id_user = '".$id_user."' order by t2.id_1_6_detail asc";
							...
							<div class="box-content nopadding">
								<form action="#" method="post" class="form-horizontal form-bordered">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<div class="fullwidth">
                                        		<input type="text" name="txtSelectNilaiP" class="input-block-level input-nilai txtSelectCustom" value="<?php echo $row_1["peran_penilai"] ?>" placeholder="Select One" readonly />
...
?>
                                                <li class="<?php if($row_p['peran'] == $row_1["peran_penilai"]) { echo "selected"; } ?>"><div data-value="<?php echo $row_p['peran']?>" data-nilai="<?php echo $row_p['nilai_p']?>"><?php echo $row_p['peran']?></div></li>
<?php
								}
?>
                                            	</ul>
									...
									<div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<div class="fullwidth">
                                        		<input type="text" name="txtSelectNilaiQ" class="input-block-level input-nilai txtSelectCustom" value="<?php echo $row_1["jenis_penilai"] ?>" placeholder="Select One" readonly />
                                                <ul class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="">Select One</div></li>
<?php
...
?>
												<li class="<?php if($row_q['jenis'] == $row_1["jenis_penilai"]) { echo "selected"; } ?>"><div data-value="<?php echo $row_q['jenis']?>" data-nilai="<?php echo $row_q['nilai_q']?>"><?php echo $row_q['jenis']?></div></li>
<?php
								}
?>
                                            	</ul>
...
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, kompetensi, nilai_kompetensi from 1_6_kompetensi where id_1_6_detail = '".$row_1["id_1_6_detail"]."' order by id_kompetensi asc";	
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	$query_uu = "select * from 1_6_kompetensi where id_1_6_detail = '".$row_1["id_1_6_detail"]."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<input type="hidden" name="id_detail" value="<?=$row_1["id_1_6_detail"]?>" />
