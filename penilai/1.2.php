...
<?php
	$query_1 = "select t1.id_user, t1.id_pendidikan_formal, IFNULL(t1.total_penilaian_penilai,t1.total_penilaian) total_penilaian, t2.id_pendidikan_formal_detail, t2.pendidikan_formal, t2.tahun_lulus, t2.jenjang, t2.program, t3.penghargaan, t3.nilai_p, t3.jenjang as jenjang2, t3.nilai_q, t3.akreditasi_prodi, t3.nilai_r, t3.penghargaan_penilai, t3.nilai_p_penilai, t3.jenjang_penilai, t3.nilai_q_penilai, t3.akreditasi_prodi_penilai, t3.nilai_r_penilai
				from 1_2 as t1
				...
				where t1.id_user = '".$id_user."' order by t2.id_pendidikan_formal_detail asc";
							...
							<div class="box-content nopadding">
								<form action="#" method="post" class="form-horizontal form-bordered">
									...
									<div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<div class="fullwidth">
                                        		<input type="text" name="txtSelectNilaiP" class="input-block-level input-nilai txtSelectCustom" value="<?php echo $row_1["penghargaan_penilai"] ?>" placeholder="Select One" readonly />
...
?>
                                                <li class="<?php if($row_p['penghargaan'] == $row_1["penghargaan_penilai"]) { echo "selected"; } ?>"><div data-value="<?php echo $row_p['penghargaan']?>" data-nilai="<?php echo $row_p['nilai_p']?>"><?php echo $row_p['penghargaan']?></div></li>
<?php
								}
?>
                                            	</ul>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<div class="fullwidth">
                                        		<input type="text" name="txtSelectNilaiQ" class="input-block-level input-nilai txtSelectCustom" value="<?php echo $row_1["jenjang_penilai"] ?>" placeholder="Select One" readonly />
                                                <ul class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="">Select One</div></li>
<?php
...
?>
												<li class="<?php if($row_q['jenjang'] == $row_1["jenjang_penilai"]) { echo "selected"; } ?>"><div data-value="<?php echo $row_q['jenjang']?>" data-nilai="<?php echo $row_q['nilai_q']?>"><?php echo $row_q['jenjang']?></div></li>
<?php
								}
?>
                                            	</ul>
									...
									<div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<div class="fullwidth">
                                        		<input type="text" name="txtSelectNilaiR" class="input-block-level input-nilai txtSelectCustom" value="<?php echo $row_1["akreditasi_prodi_penilai"] ?>" placeholder="Select One" readonly />
                                                <ul class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="">Select One</div></li>
<?php
...
?>
                                                <li class="<?php if($row_r['akreditasi_prodi'] == $row_1["akreditasi_prodi_penilai"]) { echo "selected"; } ?>"><div data-value="<?php echo $row_r['akreditasi_prodi']?>" data-nilai="<?php echo $row_r['nilai_r']?>"><?php echo $row_r['akreditasi_prodi']?></div></li>
<?php
								}
?>
                                            	</ul>
...
<?php
	$i = 0;
	$query_2 = "select kompetensi, nilai_kompetensi, id_kompetensi from 1_2_kompetensi where id_pendidikan_formal_detail = '".$row_1["id_pendidikan_formal_detail"]."' order by id_kompetensi asc";	
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	$query_uu = "select * from 1_2_kompetensi where id_pendidikan_formal_detail = '".$row_1["id_pendidikan_formal_detail"]."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<input type="hidden" name="id_detail" value="<?=$row_1["id_pendidikan_formal_detail"]?>" />
