...
<?php
	$query_1 = "select t1.id_user, t1.id_3_2, IFNULL(t1.total_penilaian_penilai, t1.total_penilaian) total_penilaian, t2.id_3_2_detail, t2.nama, t2.perguruan, t2.sejak, t2.sampai, t2.jumlah_jam, t2.jumlah_selesai, t3.jenis, t3.nilai_p, t3.peran, t3.nilai_q, t3.cakupan, t3.nilai_r, t3.jenis_penilai, t3.nilai_p_penilai, t3.peran_penilai, t3.nilai_q_penilai, t3.cakupan_penilai, t3.nilai_r_penilai
				from 3_2 as t1
				join 3_2_detail as t2 on t2.id_3_2 = t1.id_3_2
				join 3_2_pqr as t3 on t3.id_3_2_detail = t2.id_3_2_detail
				where t1.id_user = '".$id_user."' order by t2.id_3_2_detail asc";
...
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, kompetensi, nilai_kompetensi from 3_2_kompetensi where id_3_2_detail = '".$row_1["id_3_2_detail"]."' order by id_kompetensi asc";	
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	$query_uu = "select * from 3_2_kompetensi where id_3_2_detail = '".$row_1["id_3_2_detail"]."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<input type="hidden" name="id_detail" value="<?=$row_1["id_3_2_detail"]?>" />
