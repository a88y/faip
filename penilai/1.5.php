...
<?php
$i = 0;
	$query_2 = "select id_kompetensi, kompetensi, nilai_kompetensi from 1_5_kompetensi where id_1_5_detail = '".$row_1["id_1_5_detail"]."' order by id_kompetensi asc";	
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	$query_uu = "select * from 1_5_kompetensi where id_1_5_detail = '".$row_1["id_1_5_detail"]."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<input type="hidden" name="id_detail" value="<?=$row_1["id_1_5_detail"]?>" />
