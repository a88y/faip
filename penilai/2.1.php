...
<?php
	$query_1 = "select t1.id_user, t1.id_2_1, IFNULL(t1.total_penilaian_penilai, t1.total_penilaian) total_penilaian, t2.id_2_1_detail, t2.nama_referensi, t2.jabatan, t2.konfirmasi, t3.konsistensi, t3.nilai_p, t3.peran, t3.nilai_q, t3.referensi, t3.nilai_r, t3.konsistensi_penilai, t3.nilai_p_penilai, t3.peran_penilai, t3.nilai_q_penilai, t3.referensi_penilai, t3.nilai_r_penilai
				from 2_1 as t1
				join 2_1_detail as t2 on t2.id_2_1 = t1.id_2_1
				join 2_1_pqr as t3 on t3.id_2_1_detail = t2.id_2_1_detail
				where t1.id_user = '".$id_user."' order by t2.id_2_1_detail asc";
							...
							<div class="box-content nopadding">
								<form action="#" method="post" class="form-horizontal form-bordered">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<div class="fullwidth">
                                        		<input type="text" name="txtSelectNilaiP" class="input-block-level input-nilai txtSelectCustom" value="<?php echo $row_1["konsistensi_penilai"] ?>" placeholder="Select One" readonly />
...
?>
                                                <li class="<?php if($row_p['konsistensi'] == $row_1["konsistensi_penilai"]) { echo "selected"; } ?>"><div data-value="<?php echo $row_p['konsistensi']?>" data-nilai="<?php echo $row_p['nilai_p']?>"><?php echo $row_p['konsistensi']?></div></li>
<?php
								}
?>
                                            	</ul>
...
?>
									...
									<div class="control-group">
                                        ...
                                        <div class="controls">
                                        	<div class="fullwidth">
                                        		<input type="text" name="txtSelectNilaiR" class="input-block-level input-nilai txtSelectCustom" value="<?php echo $row_1["referensi_penilai"] ?>" placeholder="Select One" readonly />
                                                <ul class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="">Select One</div></li>
<?php
...
?>
                                                <li class="<?php if($row_r['referensi'] == $row_1["referensi_penilai"]) { echo "selected"; } ?>"><div data-value="<?php echo $row_r['referensi']?>" data-nilai="<?php echo $row_r['nilai_r']?>"><?php echo $row_r['referensi']?></div></li>
<?php
								}
?>
                                            	</ul>
...
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, kompetensi, nilai_kompetensi from 2_1_kompetensi where id_2_1_detail = '".$row_1["id_2_1_detail"]."' order by id_kompetensi asc";	
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	$query_uu = "select * from 2_1_kompetensi where id_2_1_detail = '".$row_1["id_2_1_detail"]."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<input type="hidden" name="id_detail" value="<?=$row_1["id_2_1_detail"]?>" />
