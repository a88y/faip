<?php
	...
	$tt_1_2 = 0;
	$query_1_2 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 1_2 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_1_3 = 0;
	$query_1_3 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 1_3 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_1_4 = 0;
	$query_1_4 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 1_4 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_1_5 = 0;
	$query_1_5 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 1_5 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_1_6 = 0;
	$query_1_6 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 1_6 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_2_1 = 0;
	$query_2_1 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 2_1 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_2_2 = 0;
	$query_2_2 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 2_2 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_3_1 = 0;
	$query_3_1 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 3_1 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_3_2 = 0;
	$query_3_2 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 3_2 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_3_3 = 0;
	$query_3_3 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 3_3 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_3_4 = 0;
	$query_3_4 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 3_4 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_3_5 = 0;
	$query_3_5 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 3_5 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_4_1 = 0;
	$query_4_1 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 4_1 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_4_2 = 0;
	$query_4_2 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 4_2 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_4_3 = 0;
	$query_4_3 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 4_3 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_4_4 = 0;
	$query_4_4 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 4_4 where id_user = '".$_SESSION['id_u5er']."'";	
	...
	$tt_5_1 = 0;
	$query_5_1 = "select IFNULL(total_penilaian_penilai ,total_penilaian) as total_penilaian from 5_1 where id_user = '".$_SESSION['id_u5er']."'";	
