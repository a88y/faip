<?php
	...
	$pagesEdit = '';
	$actionSave = 'add';
	$titleHeader = 'IV.3 Seminar / Lokakarya yang Diikuti';
	$titleHeaderAction = '';
	$tempat = '';
	$penyelenggara = '';
	$selectNilaiP = '';
	...
	if ( isset($_GET['action']) && $_GET['action']=='edit' ) {  
		if(isset($_GET['id'])){
			...
			$query_id = "select * from 4_3_detail where id_4_3_detail = '".$id."' limit 1";
			...
			if( mysqli_num_rows($result_id) > 0 ) {
				while($row_id = mysqli_fetch_array($result_id)) {
					...
					$id_4_3				= $row_id["id_4_3"];
					$id_4_3_detail		= $row_id["id_4_3_detail"];
					$tempat				= $row_id["tempat"];
					$penyelenggara		= $row_id["penyelenggara"];
					
					$query_tt = "select * from 4_3_pqr where id_4_3_detail = '".$id_4_3_detail."' limit 1";
					...
					$query_xx = "select * from 4_3 where id_4_3 = '".$id_4_3."' && id_user = '".$_SESSION['id_u5er']."' limit 1";
					...
					if( mysqli_num_rows($result_xx) > 0 ) {
						...
						header('location: ./4.3.php?err=='.base64_encode('Id tidak ditemukan.'));		
						exit();
					}
							...
							<div class="box-content nopadding">
								<form action="#" method="post" class="form-horizontal form-bordered">
									...
									<div class="control-group">
										<label class="control-label">Nama, Tempat dan Tahun Seminar/Lokakarya</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label">Penyelenggara Seminar/Lokakarya</label>
										<div class="controls">
                                            <div class="input-block-level"><p><?php echo $row_1["penyelenggara"]?></p></div>
										</div>
									</div>
                                                                                                  
                                    <div class="control-group">
										<label class="control-label">Jenis Seminar/Lokakarya</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label">Cakupan Seminar/Lokakarya</label>
										<div class="controls">
                                    ...
                                    <div class="control-group">
										<label class="control-label">Kompetensi yang relevan dengan Seminar/Lokakarya Keinsinyuran yang Diikuti</label>
										<div class="controls">
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, id_4_3_detail, kompetensi, nilai_kompetensi from 4_3_kompetensi where id_4_3_detail = '".$row_1["id_4_3_detail"]."' order by id_kompetensi asc";	
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<?php if($pagesEdit != true && $status_penilai == 0){ ?>
                                            		<a href="./4.3.php?action=edit&id=<?php echo base64_encode($row_1["id_4_3_detail"]) ?>"><div class="btn btn-primary btn-edit">Edit</div></a>						
											<?php } else { ?>
				...
				<div id="coloumn-content" class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							...
							<div class="box-content nopadding">
                                <form action="./func/4.3.add.php" method="post" class="form-horizontal form-bordered form-validate" id="form1">
									...
									<div class="control-group">
										<label class="control-label">Nama, Tempat dan Tahun Seminar/Lokakarya</label>
										<div class="controls">                                        
                                        	<textarea name="txtNama" id="txtNama" rows="3" class="input-block-level" data-rule-required="true"><?php echo $tempat ?></textarea>
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Penyelenggara Seminar/Lokakarya</label>
										<div class="controls">                                        
                                        	<input type="text" name="txtPenyelenggara" id="txtPenyelenggara" class="input-block-level" value="<?php echo $penyelenggara ?>" data-rule-required="true">
										</div>
									</div>
...
<?php
								$query_p = "select * from 4_3_p where 1;";
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiQ" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_q = "select * from 4_3_q where 1;";
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiR" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_r = "select * from 4_3_r where 1;";
...
$uu = 0;
$idKopetensi = '';
$query_k = "select * from bakuan_kompetensi where step = 'IV.3' order by id_bakuan_kompetensi asc";
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	if($pagesEdit == true){
		...
		$query_uu = "select * from 4_3_kompetensi where id_4_3_detail = '".$id_4_3_detail."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                            ...
                                            <input type="hidden" name="txtIdEdit" value="<?php echo base64_encode($id_4_3_detail) ?>"/>
                                            <a href="./4.3.php"><div class="btn btn-inverse">Batal</div></a>
                            ...
                            <div class="control-nav">
                                <a href="./4.2.php"><div class="btn btn-primary">Prev</div></a>
                                <a href="./4.4.php"><div class="btn btn-primary">Next</div></a>
                            </div>
						</div>
					</div>
				</div>
