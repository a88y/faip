<?php
	...
	$pagesEdit = '';
	$actionSave = 'add';
	$titleHeader = 'II.1 Referensi Kode Etik dan Etika Profesi';
	$titleHeaderAction = '';
	$nama_referensi = '';
	$jabatan = '';
	$konfirmasi = '';
	...
	if ( isset($_GET['action']) && $_GET['action']=='edit' ) {  
		if(isset($_GET['id'])){
			...
			$query_id = "select * from 2_1_detail where id_2_1_detail = '".$id."' limit 1";
			...
			if( mysqli_num_rows($result_id) > 0 ) {
				while($row_id = mysqli_fetch_array($result_id)) {
					...
					$id_2_1			= $row_id["id_2_1"];
					$id_2_1_detail	= $row_id["id_2_1_detail"];
					$nama_referensi	= $row_id["nama_referensi"];
					$jabatan		= $row_id["jabatan"];
					$konfirmasi		= $row_id["konfirmasi"];
					
					$query_tt = "select * from 2_1_pqr where id_2_1_detail = '".$id_2_1_detail."' limit 1";
					$result_tt = mysqli_query($dbLink,$query_tt);
					if( mysqli_num_rows($result_tt) > 0 ) {
						while($row_tt = mysqli_fetch_array($result_tt)) {
							$selectNilaiP 	  = $row_tt["konsistensi"];
							$nilaiP 		  = $row_tt["nilai_p"];
							$selectNilaiQ 	  = $row_tt["peran"];
							$nilaiQ 		  = $row_tt["nilai_q"];
							$selectNilaiR 	  = $row_tt["referensi"];
							$nilaiR 		  = $row_tt["nilai_r"];
						}
					}
					
					$query_xx = "select * from 2_1 where id_2_1 = '".$id_2_1."' && id_user = '".$_SESSION['id_u5er']."' limit 1";
					...
					if( mysqli_num_rows($result_xx) > 0 ) {
						...
						header('location: ./2.1.php?err=='.base64_encode('Id tidak ditemukan.'));		
						exit();
					}
...
<?php
	$query_1 = "select t1.id_user, t1.id_2_1, IFNULL(t1.total_penilaian_penilai ,t1.total_penilaian) as total_penilaian, t2.id_2_1_detail, t2.nama_referensi, t2.jabatan, t2.konfirmasi, t3.konsistensi, IFNULL(t3.nilai_p_penilai ,t3.nilai_p) as nilai_p, t3.peran, IFNULL(t3.nilai_q_penilai ,t3.nilai_q) as nilai_q, t3.referensi, IFNULL(t3.nilai_r_penilai ,t3.nilai_r) as nilai_r
				from 2_1 as t1
				join 2_1_detail as t2 on t2.id_2_1 = t1.id_2_1
				join 2_1_pqr as t3 on t3.id_2_1_detail = t2.id_2_1_detail
				where t1.id_user = '".$_SESSION['id_u5er']."' order by t2.id_2_1_detail asc";
							...
							<div class="box-content nopadding">
								<form action="#" method="post" class="form-horizontal form-bordered">
									...
									<div class="control-group">
										<label class="control-label">Nama Referensi / Rujukan</label>
										<div class="controls">
                                            <div class="input-block-level"><p><?php echo $row_1["nama_referensi"]?></p></div>
										</div>
									</div>
                                
									<div class="control-group">
										<label class="control-label">Kedudukan / Jabatan Referensi</label>
										<div class="controls">
                                            <div class="input-xxlarge"><p><?php echo $row_1["jabatan"]?></p></div>
										</div>
									</div>
                                    
									<div class="control-group">
										<label class="control-label">Hal yang dianggap dapat dikonfirmasi oleh Referensi / Rujukan</label>
										<div class="controls">
                                            <div class="input-block-level"><p><?php echo $row_1["konfirmasi"]?></p></div>
										</div>
									</div>
                                                                                                            
                                    <div class="control-group">
										<label class="control-label">Konsistensi Kepatuhan Kode Etik dan Etika Profesi</label>
										<div class="controls">
                                            <div class="input-block-level input-nilai"><p><?php echo $row_1["konsistensi"]?></p></div>
                                            <div class="div-nilai"><span>Nilai P :</span> <?php echo $row_1["nilai_p"]?></div>
										</div>
									</div>
                                    
									<div class="control-group">
										<label class="control-label">Peran / Keterlibatan</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label">Referensi yang Terkait Penegakan Kode Etik dan Etika Profesi</label>
										<div class="controls">
                                            <div class="input-block-level input-nilai"><p><?php echo $row_1["referensi"]?></p></div>
                                            <div class="div-nilai"><span>Nilai R :</span> <?php echo $row_1["nilai_r"]?></div>
										</div>
									</div>
                                    
                                    <div class="control-group">
										<label class="control-label">Kompetensi yang relevan dengan Kode Etik dan Etika Profesi</label>
										<div class="controls">
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, id_2_1_detail, kompetensi, nilai_kompetensi from 2_1_kompetensi where id_2_1_detail = '".$row_1["id_2_1_detail"]."' order by id_kompetensi asc";	
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<?php if($pagesEdit != true && $status_penilai == 0){ ?>
                                            		<a href="./2.1.php?action=edit&id=<?php echo base64_encode($row_1["id_2_1_detail"]) ?>"><div class="btn btn-primary btn-edit">Edit</div></a>								
											<?php } else { ?>
				...
				<div id="coloumn-content" class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							...
							<div class="box-content nopadding">
                                <form action="./func/2.1.add.php" method="post" class="form-horizontal form-bordered form-validate" id="form1">
									...
									<div class="control-group">
										<label class="control-label">Nama Referensi / Rujukan</label>
										<div class="controls">
                                        <input type="text" name="txtNamaReferensi" id="txtNamaReferensi" class="input-block-level" value="<?php echo $nama_referensi ?>" data-rule-required="true">
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Kedudukan / Jabatan Referensi</label>
										<div class="controls">
                                        <input type="text" name="txtKedudukan" id="txtKedudukan" class="input-xxlarge" value="<?php echo $jabatan ?>" data-rule-required="true">
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Hal yang dianggap dapat dikonfirmasi oleh Referensi / Rujukan</label>
										<div class="controls">
                                        	<input type="text" name="txtHalReferensi" id="txtHalReferensi" class="input-block-level" value="<?php echo $konfirmasi ?>" data-rule-required="true">
										</div>
									</div>
...
<?php
								$query_p = "select * from 2_1_p where 1;";
								$result_p = mysqli_query($dbLink,$query_p);
								while($row_p = mysqli_fetch_array($result_p)) {
?>
                                                <li class="<?php if($row_p['konsistensi'] == $selectNilaiP) { echo "selected"; } ?>"><div data-value="<?php echo $row_p['konsistensi']?>" data-nilai="<?php echo $row_p['nilai_p']?>"><?php echo $row_p['konsistensi']?></div></li>
<?php
								}
?>
                                            	</ul>
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiQ" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_q = "select * from 2_1_q where 1;";
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiR" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_r = "select * from 2_1_r where 1;";
								$result_r = mysqli_query($dbLink,$query_r);
								while($row_r = mysqli_fetch_array($result_r)) {
?>
                                                <li class="<?php if($row_r['referensi'] == $selectNilaiR) { echo "selected"; } ?>"><div data-value="<?php echo $row_r['referensi']?>" data-nilai="<?php echo $row_r['nilai_r']?>"><?php echo $row_r['referensi']?></div></li>
<?php
								}
?>
                                            	</ul>
...
$uu = 0;
$idKopetensi = '';
$query_k = "select * from bakuan_kompetensi where step = 'II.1' order by id_bakuan_kompetensi asc";
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	if($pagesEdit == true){
		...
		$query_uu = "select * from 2_1_kompetensi where id_2_1_detail = '".$id_2_1_detail."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                            ...
                                            <input type="hidden" name="txtIdEdit" value="<?php echo base64_encode($id_2_1_detail) ?>"/>
                                            <a href="./2.1.php"><div class="btn btn-inverse">Batal</div></a>
                            ...
                            <div class="control-nav">
                                <a href="./1.6.php"><div class="btn btn-primary">Prev</div></a>
                                <a href="./2.2.php"><div class="btn btn-primary">Next</div></a>
                            </div>
						</div>
					</div>
				</div>
