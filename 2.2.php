<?php
	...
	$pagesEdit = '';
	$actionSave = 'add';
	$titleHeader = 'II.2 Pengertian, Pendapat dan Pengalaman Kode Etik dan Etika Profesi Sendiri';
	$titleHeaderAction = '';
	$pendapat = '';
	$tgl = '';
	$program = '';
	...
	if ( isset($_GET['action']) && $_GET['action']=='edit' ) {  
		if(isset($_GET['id'])){
			...
			$query_id = "select * from 2_2_detail where id_2_2_detail = '".$id."' limit 1";
			...
			if( mysqli_num_rows($result_id) > 0 ) {
				while($row_id = mysqli_fetch_array($result_id)) {
					...
					$id_2_2			= $row_id["id_2_2"];
					$id_2_2_detail	= $row_id["id_2_2_detail"];
					$pendapat		= $row_id["pendapat"];
					$tgl			= $row_id["tgl"];
					$program		= $row_id["program"];
					
					$query_tt = "select * from 2_2_pqr where id_2_2_detail = '".$id_2_2_detail."' limit 1";
					$result_tt = mysqli_query($dbLink,$query_tt);
					if( mysqli_num_rows($result_tt) > 0 ) {
						while($row_tt = mysqli_fetch_array($result_tt)) {
							$selectNilaiP 	  = $row_tt["akibat"];
					...
					$query_xx = "select * from 2_2 where id_2_2 = '".$id_2_2."' && id_user = '".$_SESSION['id_u5er']."' limit 1";
					...
					if( mysqli_num_rows($result_xx) > 0 ) {
						...
						header('location: ./2.2.php?err=='.base64_encode('Id tidak ditemukan.'));		
						exit();
					}
...
<?php
	$query_1 = "select t1.id_user, t1.id_2_2, IFNULL(t1.total_penilaian_penilai ,t1.total_penilaian) as total_penilaian, t2.id_2_2_detail, t2.pendapat, t2.tgl, t2.program, t3.akibat, IFNULL(t3.nilai_p_penilai ,t3.nilai_p) as nilai_p, t3.peran, IFNULL(t3.nilai_q_penilai ,t3.nilai_q) as nilai_q, t3.cakupan, IFNULL(t3.nilai_r_penilai ,t3.nilai_r) as nilai_r
				from 2_2 as t1
				join 2_2_detail as t2 on t2.id_2_2 = t1.id_2_2
				join 2_2_pqr as t3 on t3.id_2_2_detail = t2.id_2_2_detail
				where t1.id_user = '".$_SESSION['id_u5er']."' order by t2.id_2_2_detail asc";
							...
							<div class="box-content nopadding">
								<form action="#" method="post" class="form-horizontal form-bordered">
									...
									<div class="control-group">
										<label class="control-label">Pengertian, Pendapat dan Pengalaman Sendiri</label>
										<div class="controls">
                                            <div class="input-block-level"><p><?php echo $row_1["pendapat"]?></p></div>
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Proyek, program, kegiatan atau kejadian yang terkait</label>
										<div class="controls">
                                            <div class="input-block-level"><p><?php echo $row_1["program"]?></p></div>
										</div>
									</div>
                                                                                                            
                                    <div class="control-group">
										<label class="control-label">Akibat Kasus Pelanggaran Kode Etik/Etika Profesi</label>
										<div class="controls">
                                            <div class="input-block-level input-nilai"><p><?php echo $row_1["akibat"]?></p></div>
									...
									<div class="control-group">
										<label class="control-label">Cakupan Kasus Kode Etik dan Etika Profesi</label>
										<div class="controls">
                                    ...
                                    <div class="control-group">
										<label class="control-label">Kompetensi yang relevan dengan Pengalaman Kode Etik Insinyur dan Etika Profesi</label>
										<div class="controls">
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, id_2_2_detail, kompetensi, nilai_kompetensi from 2_2_kompetensi where id_2_2_detail = '".$row_1["id_2_2_detail"]."' order by id_kompetensi asc";	
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<?php if($pagesEdit != true && $status_penilai == 0){ ?>
                                            		<a href="./2.2.php?action=edit&id=<?php echo base64_encode($row_1["id_2_2_detail"]) ?>"><div class="btn btn-primary btn-edit">Edit</div></a>										
											<?php } else { ?>
				...
				<div id="coloumn-content" class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							...
							<div class="box-content nopadding">
                                <form action="./func/2.2.add.php" method="post" class="form-horizontal form-bordered form-validate" id="form1">
									...
									<div class="control-group">
										<label class="control-label">Pengertian, Pendapat dan Pengalaman Sendiri</label>
										<div class="controls">
                                        <textarea name="txtNamaPengertian" id="txtNamaPengertian" rows="3" class="input-block-level" data-rule-required="true"><?php echo $pendapat ?></textarea>
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Proyek, program, kegiatan atau kejadian yang terkait</label>
										<div class="controls">
                                        	<input type="text" name="txtProyek" id="txtProyek" class="input-block-level" value="<?php echo $program ?>" data-rule-required="true">
										</div>
									</div>
...
<?php
								$query_p = "select * from 2_2_p where 1;";
								$result_p = mysqli_query($dbLink,$query_p);
								while($row_p = mysqli_fetch_array($result_p)) {
?>
                                                <li class="<?php if($row_p['akibat'] == $selectNilaiP) { echo "selected"; } ?>"><div data-value="<?php echo $row_p['akibat']?>" data-nilai="<?php echo $row_p['nilai_p']?>"><?php echo $row_p['akibat']?></div></li>
<?php
								}
?>
                                            	</ul>
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiQ" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_q = "select * from 2_2_q where 1;";
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiR" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_r = "select * from 2_2_r where 1;";
...
$uu = 0;
$idKopetensi = '';
$query_k = "select * from bakuan_kompetensi where step = 'II.2' order by id_bakuan_kompetensi asc";
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	if($pagesEdit == true){
		...
		$query_uu = "select * from 2_2_kompetensi where id_2_2_detail = '".$id_2_2_detail."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                            ...
                                            <input type="hidden" name="txtIdEdit" value="<?php echo base64_encode($id_2_2_detail) ?>"/>
                                            <a href="./2.2.php"><div class="btn btn-inverse">Batal</div></a>
                            ...
                            <div class="control-nav">
                                <a href="./2.1.php"><div class="btn btn-primary">Prev</div></a>
                                <a href="./3.1.php"><div class="btn btn-primary">Next</div></a>
                            </div>
						</div>
					</div>
				</div>
