<?php
	...
	$pagesEdit = '';
	$actionSave = 'add';
	$titleHeader = 'V Bahasa yang Dikuasai';
	$titleHeaderAction = '';
	$bahasa = '';
	$lisan = '';
	$tulisan = '';
	...
	if ( isset($_GET['action']) && $_GET['action']=='edit' ) {  
		if(isset($_GET['id'])){
			...
			$query_id = "select * from 5_1_detail where id_5_1_detail = '".$id."' limit 1";
			...
			if( mysqli_num_rows($result_id) > 0 ) {
				while($row_id = mysqli_fetch_array($result_id)) {
					...
					$id_5_1				= $row_id["id_5_1"];
					$id_5_1_detail		= $row_id["id_5_1_detail"];
					$bahasa				= $row_id["bahasa"];
					$lisan				= $row_id["lisan"];
					$tulisan			= $row_id["tulisan"];
					
					$query_tt = "select * from 5_1_pqr where id_5_1_detail = '".$id_5_1_detail."' limit 1";
					...
					$query_xx = "select * from 5_1 where id_5_1 = '".$id_5_1."' && id_user = '".$_SESSION['id_u5er']."' limit 1";
					...
					if( mysqli_num_rows($result_xx) > 0 ) {
						...
						header('location: ./5.1.php?err=='.base64_encode('Id tidak ditemukan.'));		
						exit();
					}
...
<?php
	$query_1 = "select t1.id_user, t1.id_5_1, IFNULL(t1.total_penilaian_penilai ,t1.total_penilaian) as total_penilaian, t2.id_5_1_detail, t2.bahasa, t2.lisan, t2.tulisan, t3.jenis, IFNULL(t3.nilai_p_penilai ,t3.nilai_p) as nilai_p, t3.peran, IFNULL(t3.nilai_q_penilai ,t3.nilai_q) as nilai_q, t3.cakupan, IFNULL(t3.nilai_r_penilai ,t3.nilai_r) as nilai_r
				from 5_1 as t1
				join 5_1_detail as t2 on t2.id_5_1 = t1.id_5_1
				join 5_1_pqr as t3 on t3.id_5_1_detail = t2.id_5_1_detail
				where t1.id_user = '".$_SESSION['id_u5er']."' order by t2.id_5_1_detail asc";
							...
							<div class="box-content nopadding">
								<form action="#" method="post" class="form-horizontal form-bordered">
									...
									<div class="control-group">
										...
										<div class="controls">
                                            <div class="input-xxlarge"><p><?php echo $row_1["bahasa"]?></p></div>
										</div>
									</div>
                                     
									<div class="control-group" style="border-bottom:none;">
										<label class="control-label">Penguasaan Bahasa</label>
                                        <div class="controls radios">
											<input type="radio" value="" disabled <?php if($row_1["lisan"] == "Lisan, Dasar") { echo "checked"; } ?>><label for="">Lisan, Dasar</label>
											<input type="radio" value="" disabled <?php if($row_1["lisan"] == "Lisan Fasih") { echo "checked"; } ?>><label for="">Lisan Fasih</label>
										</div>
									</div>
									...
									<div class="control-group">
                                        ...
                                        <div class="controls radios">
											<input type="radio" value="" disabled <?php if($row_1["tulisan"] == "Menulis, Dasar") { echo "checked"; } ?>><label for="">Menulis, Dasar</label>
											<input type="radio" value="" disabled <?php if($row_1["tulisan"] == "Menulis, Lancar (E-mail, Meeting Notes)") { echo "checked"; } ?>><label for="">Menulis, Lancar (E-mail, Meeting Notes)</label>
											<input type="radio" value="" disabled <?php if($row_1["tulisan"] == "Menulis, Sangat Baik (Esai. Laporan, Buku)") { echo "checked"; } ?>><label for="">Menulis, Sangat Baik (Esai. Laporan, Buku)</label>
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Peran / Penggunaan Bahasa yang Dikuasai</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label">Cakupan Bahasa yang Dikuasai dalam Profesi</label>
										<div class="controls">
                                    ...
                                    <div class="control-group">
										<label class="control-label">Kompetensi yang relevan dengan Bahasa yang Dikuasai</label>
										<div class="controls">
<?php
	$i = 0;
	$query_2 = "select id_kompetensi, id_5_1_detail, kompetensi, nilai_kompetensi from 5_1_kompetensi where id_5_1_detail = '".$row_1["id_5_1_detail"]."' order by id_kompetensi asc";	
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                        	<?php if($pagesEdit != true && $status_penilai == 0){ ?>
                                            		<a href="./5.1.php?action=edit&id=<?php echo base64_encode($row_1["id_5_1_detail"]) ?>"><div class="btn btn-primary btn-edit">Edit</div></a>								
											<?php } else { ?>
				...
				<div id="coloumn-content" class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							...
							<div class="box-content nopadding">
                                <form action="./func/5.1.add.php" method="post" class="form-horizontal form-bordered form-validate" id="form1">
									...
									<div class="control-group">
										<label class="control-label">Bahasa</label>
										<div class="controls">
                                        	<select name="txtBahasa" id="txtBahasa" class="input-xxlarge">
                                            	<option value="" data-nilai="0" selected >Select One</option>
<?php
								$query_bhs = "select * from bahasa where 1 order by bahasa asc;";
								$result_bhs = mysqli_query($dbLink,$query_bhs);
								while($row_bhs = mysqli_fetch_array($result_bhs)) {
?>
                                            	<option value="<?php echo $row_bhs['bahasa']?>" data-nilai="<?php echo $row_bhs['native']?>" <?php if($row_bhs['bahasa'] == $bahasa) { echo "selected"; } ?>><?php echo $row_bhs['bahasa']?></option>
<?php
								}
?>
                                            </select>
									...
									<div class="control-group" style="border-bottom:none;">
										<label class="control-label">Penguasaan Bahasa</label>
                                        <div class="controls radios">
											<input type="radio" name="txtLisan" value="Lisan, Dasar" <?php if($lisan == "Lisan, Dasar") { echo "checked"; } ?>><label for="">Lisan, Dasar</label>
											<input type="radio" name="txtLisan" value="Lisan Fasih" <?php if($lisan == "Lisan Fasih") { echo "checked"; } ?>><label for="">Lisan Fasih</label>
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label"></label>
                                        <div class="controls radios">
											<input type="radio" name="txtTulisan" value="Menulis, Dasar" <?php if($tulisan == "Menulis, Dasar") { echo "checked"; } ?>><label for="">Menulis, Dasar</label>
											<input type="radio" name="txtTulisan" value="Menulis, Lancar (E-mail, Meeting Notes)" <?php if($tulisan == "Menulis, Lancar (E-mail, Meeting Notes)") { echo "checked"; } ?>><label for="">Menulis, Lancar (E-mail, Meeting Notes)</label>
											<input type="radio" name="txtTulisan" value="Menulis, Sangat Baik (Esai. Laporan, Buku)" <?php if($tulisan == "Menulis, Sangat Baik (Esai. Laporan, Buku)") { echo "checked"; } ?>><label for="">Menulis, Sangat Baik (Esai. Laporan, Buku)</label>
										</div>
									</div>
...
<?php
								$query_p = "select * from 5_1_p where 1;";
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiQ" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_q = "select * from 5_1_q where 1;";
										...
										<div class="controls">
                                        	<div class="fullwidth">
                                                ...
                                                <ul id="ulSelectNilaiR" class="ulSelectCustom input-nilai">
                                                    <li><div data-value="" data-nilai="0">Select One</div></li>
<?php
								$query_r = "select * from 5_1_r where 1;";
...
$uu = 0;
$idKopetensi = '';
$query_k = "select * from bakuan_kompetensi where step = 'V' order by id_bakuan_kompetensi asc";
...
while($row_k = mysqli_fetch_array($result_k)) {
	...
	if($pagesEdit == true){
		...
		$query_uu = "select * from 5_1_kompetensi where id_5_1_detail = '".$id_5_1_detail."' && kompetensi = '".$valueKopetensi."' limit 1";
...
?>
                                    ...
                                    <div class="control-group" style="background-color:transparent;">
                                        <div class="controls" style="border-left:none;">
                                            ...
                                            <input type="hidden" name="txtIdEdit" value="<?php echo base64_encode($id_5_1_detail) ?>"/>
                                            <a href="./5.1.php"><div class="btn btn-inverse">Batal</div></a>
                            ...
                            <div class="control-nav">
                                <a href="./4.4.php"><div class="btn btn-primary">Prev</div></a>
<?php if($status_penilai == 1){ ?>
                                <div class="btn btn-disabled">Next</div>
<?php } else { ?>
								<a href="./finish.php"><div class="btn btn-primary">Next</div></a>
<?php } ?>
                            </div>
						</div>
					</div>
